        ...
        <>
            <div className='topbardiv'>
                ...
                <div className="topbarSearch">
                    ...
                    <input type="text" placeholder='Serch Freind and Post' />
                </div>
                ...
                <div className='topbarRight'>
                    ...
                    <div className="topbarAlerts">
                        <div><IoMdPerson fontSize="20px"/><span className='warn'>1</span></div>
                        <div><MdMessage fontSize="20px"/><span className='warn'>1</span></div>
                        <div><FaBell fontSize="20px" onClick={logOuthanlder}/><span className='warn'>1</span></div>
